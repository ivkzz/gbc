...
![Telegram Notification](./tg.png)

Проект отслеживает поток заказов из RetailCRM (webhook/sync), сохраняет их в Supabase и визуализирует на дашборде.

При написании кода использовал Antigravity + Antigravity Awesome Skill. 
План разработки implementation_plan.md.
Трудности только возникли, не усмотрел в retailcrm что триггеры по умолчанию не активны.

### Основные возможности:
- 📊 **Realtime Dashboard**: Мгновенное обновление списка заказов без перезагрузки (Supabase Realtime).
- 📈 **Аналитика**: Динамические графики выручки с фильтрами (День, Неделя, Месяц, Все время).
- 🤖 **RetailCRM Sync**: Полная синхронизация заказов через вебхуки и API.
- 🚀 **Telegram Bot**: Уведомления о новых заказах прямо в мессенджер.
